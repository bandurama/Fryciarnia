	...
	return (
		<>
			...
			<div className="wrapper">
				...
				<div className="card" style={{backgroundImage: 'url(history0.jpg)'}}>
				</div>
				<div className="card" id="card-search" style={{backgroundImage: 'url(history1.jpg)'}}>
				</div>
				<div className="card" id="card-history">
				...
				<div className="card" style={{backgroundImage: 'url(history3.jpg)'}}>
				</div>
				<div className="card" id="card-search" style={{backgroundImage: 'url(history4.jpg)'}}>
				</div>
				<div className="card" id="card-history">
